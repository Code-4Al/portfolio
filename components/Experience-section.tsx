...
export function ExperienceSection() {
  return (
    <section id="experiences" className="py-10 bg-muted/30 flex justify-center">
      <div className="w-full max-w-5xl px-6">
        ...
        <div className="flex justify-center">
          {' '}
          {/* ⬅ Center content */}
          <div className="grid md:grid-cols-1 lg:grid-cols-1 gap-8 w-full max-w-3xl">
            {experiences.map((experience, index) => (
              <Card
                key={experience.title}
                className="group hover:shadow-2xl transition-all duration-300 animate-fade-in-up mx-auto w-full"
              ...
              >
                <div className="relative overflow-hidden rounded-t-lg">
                  <img
                    ...
                    className="w-full max-h-26 object-contain group-hover:scale-105 transition-transform duration-300"
                  />
                </div>
